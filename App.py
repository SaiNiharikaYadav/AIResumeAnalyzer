...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Niha123',db='cv')
...
def run():
    ...
    img = Image.open(r"C:\Users\Niharika\OneDrive\Desktop\AI-Resume-Analyzer-main\AI-Resume-Analyzer-main\screenshots\RESUME.png")
    st.image(img)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>Niharika</b> as username and <b>Niha@123</b> as password.<br/>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'Niharika' and ad_password == 'Niha@123':
                ...
                st.success("Welcome Niha ! Total %d " % values + " User's Have Used Our Tool : )")                
